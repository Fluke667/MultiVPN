...
networkname ${PEERVPN_NETWORKNAME:-VPN$RANDOM}
...
initpeers ${PEERVPN_INITPEERS:-example.com 7000}
...
enabletunneling ${PEERVPN_ENABLETUNNELING:-yes}
...
interface ${PEERVPN_INTERFACE:-peervpn0}
...
ifconfig4 ${PEERVPN_IFCONFIG4:-172.16.254.$(expr $RANDOM % 256)/24}
...
ifconfig6 ${PEERVPN_IFCONFIG4:-fe80::1034:56ff:fe78:$(expr $RANDOM % 10000)/64}
...
enableipv4 ${PEERVPN_ENABLEIPV4:-yes}
...
enableipv6 ${PEERVPN_ENABLEIPV6:-no}
...
enablerelay ${PEERVPN_ENABLERELAY:-no}
